...
MODALITIES["video_ssl"] = Modality()  # video: discrete token
...
MODALITIES["video_feat"] = Modality(discrete=False)  # video: continuous feature 
...
SPEECHLM_TASKS["visual_tts_conti"] = SpeechLMTaskTemplate(  # for continuous video feature
    conditions=[
        ("text", "g2p", "text"),
        ("utt2spk", "spk", "text"),
        ("video.scp", "video_feat", "kaldi_ark"),
    ],
    targets=[("wav.scp", "codec", "kaldi_ark")],
)
