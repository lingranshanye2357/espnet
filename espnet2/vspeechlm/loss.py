import torch
import logging
from espnet2.vspeechlm.net_utils import length_mask


class VSpeechLMCrossEntropyLoss(torch.nn.Module):
    def __init__(
        self,
        pad,
        vocab_size,
        ...
        """
        Compute the CrossEntropy for VSpeechLM. The main motivation of this module is to save computing.
