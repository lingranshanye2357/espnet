...
def parse_arguments():
    ...
    parser.add_argument('--wav_source_dir', type=str, default='/data-03/yuyue/datasets/lrs2/wav_16k')
    parser.add_argument('--video_source_dir', type=str, default='/data-03/yuyue/datasets/lrs2/video_25fps')
    parser.add_argument('--data_split_dir', type=str, default='/data-03/yuyue/datasets/lrs2')
    parser.add_argument('--utt2spk_path', type=str, default='/data-03/yuyue/datasets/lrs2/id2spk.txt')

    args = parser.parse_args()

    return args

def get_spk_dict(utt2spk_path):
    utt2spk = dict()
    with open(utt2spk_path, 'r') as file:
        for line in file.readlines():
            utt, speaker_id = line.strip().split(' ')
            utt2spk[utt] = speaker_id
...
if __name__ == "__main__":
    ...
    all_data_list = []
    utt2spk_dict = get_spk_dict(args.utt2spk_path)
